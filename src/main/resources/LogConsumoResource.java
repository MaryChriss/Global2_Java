...
public class LogConsumoResource {
    ...
    public Response adicionarLogConsumo(LogConsumo logConsumo, @Context UriInfo uriInfo) {
        try {
            ...
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Erro ao adicionar log de consumo.").build();
        }
    }
    ...
    public Response atualizarLogConsumo(@PathParam("id") int id, LogConsumo logConsumo) {
        try {
            ...
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Erro ao atualizar log de consumo.").build();
        }
    }
    ...
    public Response excluirLogConsumo(@PathParam("id") int id) {
        try {
            ...
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Erro ao excluir log de consumo.").build();
        }
    }
    ...
    public Response listarLogsConsumo() {
        try {
            ...
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity("Erro ao listar logs de consumo.").build();
        }
    }
    ...
    public Response buscarLogConsumoPorId(@PathParam("id") int id) {
        try {
            ...
            return Response.status(Response.Status.NOT_FOUND).entity("Log de consumo não encontrado.").build();
        }
    }
}
